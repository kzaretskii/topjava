...
public class JdbcMealRepository implements MealRepository {
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? and date_trunc('day', datetime)>=?" +
                " and date_trunc('day', datetime)<? ORDER BY datetime DESC", ROW_MAPPER, userId, startDateTime, endDateTime);
    }
}
