...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 10, 0), "Завтрак user2", 1000),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 13, 0), "Обед user2", 500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 20, 0), "Ужин user2", 410)
    );
